...
{{
var G__6081 = cljs.core.pop.call(null,v__$1);
v__$1 = G__6081;
continue;
}
} else
...
{var pred__6085 = cljs.core._EQ_;var expr__6086 = limit;if(pred__6085.call(null,1,expr__6086))
{return cljs.core.vector.call(null,s);
} else
{if(pred__6085.call(null,2,expr__6086))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__6088 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6089 = (limit__$1 - 1);
var G__6090 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__6088;
limit__$1 = G__6089;
parts = G__6090;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___6092 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___6092))
{var replacement_6093 = temp__4090__auto___6092;buffer.append([cljs.core.str(replacement_6093)].join(''));
} else
{buffer.append(ch);
}
{
