...
boxcloj.core.draw_all_BANG_ = (function draw_all_BANG_(args){var G__5029 = cljs.core.first.call(null,args);var vec__5030 = G__5029;var x = cljs.core.nth.call(null,vec__5030,0,null);var y = cljs.core.nth.call(null,vec__5030,1,null);var r = cljs.core.nth.call(null,vec__5030,2,null);var cdr = cljs.core.rest.call(null,args);var G__5029__$1 = G__5029;var cdr__$1 = cdr;while(true){
var vec__5031 = G__5029__$1;var x__$1 = cljs.core.nth.call(null,vec__5031,0,null);var y__$1 = cljs.core.nth.call(null,vec__5031,1,null);var r__$1 = cljs.core.nth.call(null,vec__5031,2,null);var cdr__$2 = cdr__$1;boxcloj.core.ctx.fillStyle = "black";
...
{{
var G__5032 = cljs.core.first.call(null,cdr__$2);
var G__5033 = cljs.core.rest.call(null,cdr__$2);
G__5029__$1 = G__5032;
cdr__$1 = G__5033;
continue;
}
...
var contact_listener_5034 = dynamics.b2ContactListener;var listener_5035 = (new contact_listener_5034());listener_5035.BeginContact = (function (c){return null;
});
boxcloj.core.world.SetContactListener(listener_5035);
body_def.type = b2body.b2_staticBody;
fix_def.shape = (new b2poly());
var wall_map_5036 = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"x","x",1013904362),cljs.core.PersistentVector.fromArray([(boxcloj.core.SCALE / 2),(boxcloj.core.SCALE + 1),(boxcloj.core.SCALE / 2),-1], true),new cljs.core.Keyword(null,"y","y",1013904363),cljs.core.PersistentVector.fromArray([(boxcloj.core.SCALE + 1),(boxcloj.core.SCALE / 2),-1,(boxcloj.core.SCALE / 2)], true),new cljs.core.Keyword(null,"width","width",1127031096),cljs.core.PersistentVector.fromArray([(boxcloj.core.SCALE / 2),1,(boxcloj.core.SCALE / 2),1], true),new cljs.core.Keyword(null,"height","height",4087841945),cljs.core.PersistentVector.fromArray([1,(boxcloj.core.SCALE / 2),1,(boxcloj.core.SCALE / 2)], true)], true);var n_5037 = 0;while(true){
if((n_5037 < 4))
{position.x = cljs.core.nth.call(null,wall_map_5036.call(null,new cljs.core.Keyword(null,"x","x",1013904362)),n_5037);
position.y = cljs.core.nth.call(null,wall_map_5036.call(null,new cljs.core.Keyword(null,"y","y",1013904363)),n_5037);
fix_def.shape.SetAsBox(cljs.core.nth.call(null,wall_map_5036.call(null,new cljs.core.Keyword(null,"width","width",1127031096)),n_5037),cljs.core.nth.call(null,wall_map_5036.call(null,new cljs.core.Keyword(null,"height","height",4087841945)),n_5037));
boxcloj.core.world.CreateBody(body_def).CreateFixture(fix_def);
{
var G__5038 = (n_5037 + 1);
n_5037 = G__5038;
continue;
}
} else
...
{{
var G__5040 = node.GetNext();
var G__5041 = cljs.core.cons.call(null,node,nodes);
node = G__5040;
nodes = G__5041;
continue;
}
